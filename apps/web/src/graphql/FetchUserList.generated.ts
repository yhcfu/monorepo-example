...
export type MyQueryQuery = { __typename?: 'Query', users: Array<{ __typename?: 'User', exampleField: string }> };
...
export type FindUserQuery = { __typename?: 'Query', user: { __typename?: 'User', exampleField: string } };
...
export function useMyQueryQuery(options?: Omit<Urql.UseQueryArgs<MyQueryQueryVariables>, 'query'>) {
  return Urql.useQuery<MyQueryQuery, MyQueryQueryVariables>({ query: MyQueryDocument, ...options });
};
